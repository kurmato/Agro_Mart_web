  ...
  <div className="flex justify-between">
    <div className="max-w-screen-lg px-4 sm:px-6 text-gray-800 sm:grid md:grid-cols-4 sm:grid-cols-2 mx-auto">
      ...
      <div className="p-5">
        ...
        <a className="my-3 block" href="/#">Support <span className="text-[#225d58] text-xs p-1">New</span></a>
      </div>
      <div className="p-5">
      ...
      <div className="p-5">
        <div className="text-sm uppercase text-indigo-600 font-bold">Security Certificate</div>
        <a className="my-3 block" href="/#">XXX XXXX, Floor 4 San Francisco, CA <span className="text-teal-600 text-xs p-1"></span></a>
        <a className="my-3 block" href="/#">contact@company.com <span className="text-teal-600 text-xs p-1"></span></a>
      </div>
    </div>
