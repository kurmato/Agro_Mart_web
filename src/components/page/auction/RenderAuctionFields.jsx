          ...
          <div className="grid gap-6">
            {["Wheat", "Jawar", "Hari Moong"].map((item, index) => (
              ...
              >
                ...
                {/* Content */}
                <div className="p-2 w-full rounded-lg shadow-sm relative">
                  <div>
                  ...
                  <div className="absolute bottom-4 right-3">
                    <button
                      className="bg-[#255f2d] text-white px-4 py-2 text-sm rounded hover:bg-[#138222]"
                      onClick={openModal}
                    >
                      Bid Now
                    </button>
                      ...
                      <div className="bg-white w-full max-w-6xl p-6 rounded-lg shadow-lg">
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between">
                            ...
                            <p className="text-sm text-gray-700">
                              Time Left: 0 Day(s) 4 Hrs 15 Min 0 Sec
                            </p>
                          </div>
                          <div className="flex">
                            <img src={img} alt="" />
            ...
            {["Wheat", "Jawar", "Hari Moong"].map((item, index) => (
              ...
              >
                ...
                <div className="p-3 w-full rounded-lg shadow-sm relative">
                  ...
                  <div className="absolute bottom-4 right-3">
                    <button
                      className="bg-[#2bcf41] text-white px-4 py-2 text-sm rounded hover:bg-[#138222]"
                      onClick={openModal}
                    >
                      Bid Now
                    </button>
